...
block_end :
       {strcasecmp(_input->LT(2)->getText().data(), "TRANSACTION")}? T_END 
     ;
...
expr_stmt :             // Standalone expression
       {strcasecmp(_input->LT(1)->getText().data(), "GO")}? expr
     ;
...
create_routine_params :
     ...
     | {strcasecmp(_input->LT(1)->getText().data(), "IS") &&
...
select_list_alias :
       {strcasecmp(_input->LT(1)->getText().data(), "INTO") && strcasecmp(_input->LT(1)->getText().data(), "FROM")}? T_AS? ident
...
from_alias_clause :
       {strcasecmp(_input->LT(1)->getText().data(), "EXEC") &&
...
delete_alias :
       {strcasecmp(_input->LT(1)->getText().data(), "ALL")}?
       T_AS? ident
     ;
...
func_param : 
       {strcasecmp(_input->LT(1)->getText().data(), "INTO")}? (ident T_EQUAL T_GREATER?)? expr  
     ;     
