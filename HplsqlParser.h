...
public:
  ...
  enum {
    ...
    RuleSet_teradata_session_option = 129, RuleSignal_stmt = 130, RuleTruncate_stmt = 131, 
    RuleUse_stmt = 132, RuleValues_into_stmt = 133, RuleWhile_stmt = 134, 
    RuleFor_cursor_stmt = 135, RuleFor_range_stmt = 136, RuleLabel = 137, 
    RuleUsing_clause = 138, RuleSelect_stmt = 139, RuleCte_select_stmt = 140, 
    RuleCte_select_stmt_item = 141, RuleCte_select_cols = 142, RuleFullselect_stmt = 143, 
    RuleFullselect_stmt_item = 144, RuleFullselect_set_clause = 145, RuleSubselect_stmt = 146, 
    RuleSelect_list = 147, RuleSelect_list_set = 148, RuleSelect_list_limit = 149, 
    RuleSelect_list_item = 150, RuleSelect_list_alias = 151, RuleSelect_list_asterisk = 152, 
    RuleInto_clause = 153, RuleFrom_clause = 154, RuleFrom_table_clause = 155, 
    RuleFrom_table_name_clause = 156, RuleFrom_subselect_clause = 157, RuleFrom_join_clause = 158, 
    RuleFrom_join_type_clause = 159, RuleFrom_table_values_clause = 160, 
    RuleFrom_table_values_row = 161, RuleFrom_alias_clause = 162, RuleTable_name = 163, 
    RuleWhere_clause = 164, RuleGroup_by_clause = 165, RuleHaving_clause = 166, 
    RuleQualify_clause = 167, RuleOrder_by_clause = 168, RuleSelect_options = 169, 
    RuleSelect_options_item = 170, RuleUpdate_stmt = 171, RuleUpdate_assignment = 172, 
    RuleUpdate_table = 173, RuleUpdate_upsert = 174, RuleMerge_stmt = 175, 
    RuleMerge_table = 176, RuleMerge_condition = 177, RuleMerge_action = 178, 
    RuleDelete_stmt = 179, RuleDelete_alias = 180, RuleDescribe_stmt = 181, 
    RuleBool_expr = 182, RuleBool_expr_atom = 183, RuleBool_expr_unary = 184, 
    RuleBool_expr_single_in = 185, RuleBool_expr_multi_in = 186, RuleBool_expr_binary = 187, 
    RuleBool_expr_logical_operator = 188, RuleBool_expr_binary_operator = 189, 
    RuleExpr = 190, RuleExpr_atom = 191, RuleExpr_interval = 192, RuleInterval_item = 193, 
    RuleExpr_concat = 194, RuleExpr_concat_item = 195, RuleExpr_case = 196, 
    RuleExpr_case_simple = 197, RuleExpr_case_searched = 198, RuleExpr_cursor_attribute = 199, 
    RuleExpr_agg_window_func = 200, RuleExpr_func_all_distinct = 201, RuleExpr_func_over_clause = 202, 
    RuleExpr_func_partition_by_clause = 203, RuleExpr_spec_func = 204, RuleExpr_func = 205, 
    RuleExpr_func_params = 206, RuleFunc_param = 207, RuleExpr_select = 208, 
    RuleExpr_file = 209, RuleHive = 210, RuleHive_item = 211, RuleHost = 212, 
    RuleHost_cmd = 213, RuleHost_stmt = 214, RuleFile_name = 215, RuleDate_literal = 216, 
    RuleTimestamp_literal = 217, RuleIdent = 218, RuleString = 219, RuleInt_number = 220, 
    RuleDec_number = 221, RuleBool_literal = 222, RuleNull_const = 223, 
    RuleNon_reserved_words = 224
  };

  explicit HplsqlParser(antlr4::TokenStream *input);
  ~HplsqlParser();
  ...
  public:
    ...
    std::vector<IdentContext *> ident();
    IdentContext* ident(size_t i);
    std::vector<antlr4::tree::TerminalNode *> T_DIV();
    antlr4::tree::TerminalNode* T_DIV(size_t i);
